   ...
   <div className="row g-3 g-md-4">
      ...
      <div key={product.id} className="col-6 col-md-4 col-lg-3">
         <div className="product-card h-100 position-relative d-flex flex-column">
            <div className="product-image-container position-relative flex-shrink-0">
               ...
               <div className="product-actions">
                  ...
                  <button 
                     className="action-btn"
                     onClick={() =>
                     handleViewProduct && handleViewProduct(product.id)}
                     title="Quick View"
                     >
                     <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className='d-flex'>
               <div className="product-info p-4 p-md-3 text-center">
                  <h3 className="product-name card-title" style={{fontSize: '0.9rem'}}>
                  {product.name || 'Product Name'}
                  </h3>
                  {product.artist && (
                  <p className="product-artist text-muted" style={{fontSize: '0.8rem'}}>
                  {product.artist}
                  </p>
                  )}
